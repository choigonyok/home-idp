...
func (c *deployClient) DeployPod(ctx context.Context, in *DeployPodRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/proto.Deploy/DeployPod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Deploy_DeployPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeployPodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeployServer).DeployPod(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Deploy/DeployPod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeployServer).DeployPod(ctx, req.(*DeployPodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
